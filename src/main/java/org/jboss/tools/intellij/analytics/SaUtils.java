...
public class SaUtils {
    ...
    public void openCustomEditor(FileEditorManager instance, String url) throws IOException {
        ...
        File reportFile = new File(SaConfig.REPORT_FILE_PATH);
        ...
        VirtualFile virtualFile = LocalFileSystem.getInstance().refreshAndFindFileByPath(SaConfig.REPORT_FILE_PATH);
    ...
    private void closeCustomEditor(FileEditorManager instance){
        ...
        if (instance.hasOpenFiles()) {
            ...
            for (VirtualFile openFile : openFiles){
                if (openFile.getName().equals(SaConfig.REPORT_FILE_NAME)){
