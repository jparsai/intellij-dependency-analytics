...
public class SaUtils {
    ...
    /**
     * <p>Get Stack Analysis for given manifest file using CLI.</p>
     *
    ...
    public void openCustomEditor(FileEditorManager instance, String url) throws IOException {
        // Create a temp file in sandbox directory which is registered with SaReportEditorProvider.
        File reportFile = new File(SaReportConfig.REPORT_FILE_PATH);
        ...
        VirtualFile virtualFile = LocalFileSystem.getInstance().refreshAndFindFileByPath(SaReportConfig.REPORT_FILE_PATH);
     ...
     * @param instance An instance of FileEditorManager.
     */
    public void closeCustomEditor(FileEditorManager instance){
        ...
        if (instance.hasOpenFiles()) {
            ...
            for (VirtualFile openFile : openFiles){
                if (openFile.getName().equals(SaReportConfig.REPORT_FILE_NAME)){
